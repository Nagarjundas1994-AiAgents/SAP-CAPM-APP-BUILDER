    ...
    "gemini": [
        {
            "id": "gemini-1.5-pro",
            "name": "Gemini 1.5 Pro",
            "label": "Gemini 1.5 Pro (Latest - Recommended)",
            "pricing_type": "paid",
            "price_summary": None,
            "created_at": None,
            "context_length": None,
            "description": "High-capacity Gemini model for larger enterprise prompts.",
            "source": "static",
            "recommended": True,
        },
        {
            ...
            "label": "Gemini 1.5 Flash (Faster)",
            "pricing_type": "paid",
            "price_summary": None,
            "created_at": None,
            "context_length": None,
            "description": "Faster Gemini option for iterative generation.",
            "source": "static",
            "recommended": False,
        },
        {
            ...
            "created_at": None,
            "context_length": None,
            "description": "Flash-tier Gemini 2.0 model.",
            "source": "static",
            "recommended": False,
        },
    ],
