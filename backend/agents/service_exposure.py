...
@with_timeout(timeout_seconds=240)  # 4 minutes for LLM-heavy service generation
async def service_exposure_agent(state: BuilderState) -> dict[str, Any]:
    """
    ...
    try:
        ...
        if not entities:
            ...
            return {
                ...
                "validation_errors": [{
                    "agent": agent_name,
                    "code": "NO_ENTITIES",
                    "message": "No entities found for service exposure.",
                    "field": "entities",
                    "severity": "error",
                }],
        ...
        return {
            ...
            "generated_service_cds": state.get("generated_service_cds", ""),
            "generated_annotations_cds": state.get("generated_annotations_cds", ""),
